...
typedef void(*func_report_radau)(double*, double*, int*);
       

void radau5_integration(double tini, double tend, double first_step, int n, double *y0,
        double *y, func_radau fcn, func_mas_radau mas_fcn, func_solout_radau solout, func_report_radau reportfun, int nReport,
...
void radau5(int *n, func_radau fcn, double *x, double *y, double *xend, double *h,
            ...
            func_report_radau reportfun, int *nReport,
            int *iout,
...
void reportfun(double t, double dt, int code);
